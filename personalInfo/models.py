...
class Profile(models.Model):
    ...
    username = models.CharField(User, on_delete=models.CASCADE,null=True,primary_key=True)
    ...
    upload_cv = models.ForeignKey(Document,null=True,blank=True)
...
class Student(models.Model):
    #_id = models.AutoField(primary_key=True)
    username = models.CharField(User, on_delete=models.CASCADE,primary_key=True)
